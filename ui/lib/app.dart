...
class App extends ConsumerWidget { //ConsumerWidget = a widget that can read Riverpod providers
  const App({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) { // WidgetRef = the "remote control" to access providers
