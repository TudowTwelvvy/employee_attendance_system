...
import 'package:ui/core/theme/responsive_sizes.dart';
...
class AppTheme {
  ...
  /// Get heading style that adapts to screen size
  ...
  /// Get body style that adapts to screen size
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(fontSize: 14.sp, color: textHint),
        hintStyle: TextStyle(fontSize: 14.sp, color: textHint),
      ),
