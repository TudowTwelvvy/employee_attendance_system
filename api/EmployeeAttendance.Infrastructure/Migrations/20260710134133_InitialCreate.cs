        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RadiusMeters = table.Column<int>(type: "int", nullable: false, defaultValue: 100),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<decimal>(type: "decimal(10,8)", precision: 10, scale: 8, nullable: false),
                    Longitude = table.Column<decimal>(type: "decimal(11,8)", precision: 11, scale: 8, nullable: false),
                    DistanceFromSite = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_WorkSites_WorkSiteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_EmployeeId_ScanDate",
                table: "AttendanceRecords",
                columns: new[] { "EmployeeId", "ScanDate" });

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_ScanDate",
                table: "AttendanceRecords",
                column: "ScanDate");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_WorkSiteId",
                table: "AttendanceRecords",
                column: "WorkSiteId");
